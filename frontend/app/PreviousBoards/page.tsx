...
import { previousBoards } from '@/app/data/previousBoards';

export default function PreviousBoardsPage() {
    const [activeYear, setActiveYear] = useState(previousBoards[0].label);
    const active = previousBoards.find((y) => y.label === activeYear)!;
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="mb-10">
                                ...
                                <h2 className="font-semibold text-4xl md:text-5xl text-[#001c3d]">
                                    {activeYear === "Spring 2020" ? "Spring 2020" : `Academic Year ${activeYear}`}
                                </h2>
                            </div>
