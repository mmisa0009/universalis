        ...
        <main className='min-h-screen'>
            ...
            <div className="max-w-3xl mx-auto p-6">
                ...
                <AccordionMenu title="How can I join the EB?">
                    <p>- As for the other boards, applications for the EB open at least once a year. Applications definitely open towards the end of period 5 and if current members decide to only stay for one semester, applications also open towards the end of period 2. You will then find information about the application procedure on Facebook, Instagram, and the newsletter. After you send in your CV and Letter of Motivation, you will be invited for an interview, or if you applied for President, you will have a debate with potential other candidates.</p>
                </AccordionMenu>
                <AccordionMenu title="How can I reach out and contact the EB if I have any questions or concerns?">
                    <p>- The easiest way to reach us is via e-mail: ucmsa-secretary@maastrichtuniversity.nl or ucmsa-president@maastrichtuniversity.nl. Alternatively, you can also look up the current members of the EB on the Universalis website and message them on Facebook or approach them at UCM!</p>
                </AccordionMenu>
                ...
                <AccordionMenu title="How can I join the AB?">
                    <p>- As for the other boards, applications for the AB open at least once a year. Applications definitely open towards the end of period 5 and if current members decide to only stay for one semester, applications also open towards the end of period 2. You will then find information about the application procedure on Facebook, Instagram, and the newsletter. After you send in your CV and Letter of Motivation, you will be invited for an interview, or if you applied for Chair, you will have a debate with potential other candidates.</p>
                </AccordionMenu>
                ...
                <AccordionMenu title="Where will I get information about committee events?">
                    <p>- Mostly, committee related information is being posted on social media and our biweekly newsletter. While most of our committees have established their own Instagram or Facebook pages, it is advisable to follow them frequently. You can find their contact information on our Instagram (ucmsa_universalis). To track all the dates of committee events, the weekly calendar, posted on the UCM students Facebook page should be followed regularly.</p>
                </AccordionMenu>
                ...
                <AccordionMenu title="How can I join committees?">
                    <p>- You can join a committee at any time and with relatively low efforts. You must be enrolled at UCM. If you are interested in a particular committee, why don ‘t you shoot them a message via Facebook, Instagram or Email to ask when and where to join? You can find their contact infos either on our website, facebook (UCM students) or Instagram (ucmsa_universalis).</p>
                </AccordionMenu>
                ...
                <AccordionMenu title="How can I join the SB?">
                    <p>- As for the other boards, applications for the SB open at least once a year. Applications definitely open towards the end of period 5 and if current members decide to only stay for one semester, applications also open towards the end of period 2. You will then find information about the application procedure on Facebook, Instagram, and the newsletter. After you send in your CV and Letter of Motivation, you will be invited for an interview, or if you applied for Chair, you will have a debate with potential other candidates.</p>
                </AccordionMenu>
