export default function Section3() {
    return (
        <div className="section3-bg text-[#001c3d] h-auto">
            ...
            <div className="flex flex-col items-center justify-center gap-4 h-screen opacity-100 text-center transform translate-y-0 transition-opacity duration-800 ease-in-out transform-gpu">
                ...
                <div className="flex gap-3 px-2">
                    <div className="flex flex-col items-center p-1 gap-1">
                        <img src="/icon-eb.png" className="w-[15vmin] h-auto" alt="eb icon" />
                    ...
                    <div className="flex flex-col items-center p-1 gap-1">
                        <img src="/icon-sb.png" className="w-[15vmin] h-auto" alt="eb icon" />
                    ...
                    <div className="flex flex-col items-center p-1 gap-1">
                        <img src="/icon-ab.png" className="w-[15vmin] h-auto" alt="eb icon" />
                    ...
                    <div className="flex flex-col items-center p-1 gap-1">
                        <img src="/icon-ib.png" className="w-[15vmin] h-auto" alt="eb icon" />
