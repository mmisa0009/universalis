                ...
                <div className='grid grid-cols-1 md:grid-cols-3 w-full mb-0 gap-8'>
                    <div className="pages text-center md:text-left">
                        ...
                        <ul className="list-none space-y-2">
                            ...
                            <li>
                                <Link href="/PrivacyPolicy" className="text-sm text-[#001C3D] hover:opacity-70 transition-opacity">
                                    Privacy Policy
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div className="contact text-center md:text-left">
                        ...
                        <div className="flex gap-3 items-center justify-center md:justify-start">
                            ...
                            <a href="https://www.instagram.com/ucmsa_universalis/" aria-label="Instagram" className="opacity-70 hover:opacity-100 transition-opacity">
                            ...
                            <a href="https://nl.linkedin.com/company/universalis" aria-label="LinkedIn" className="opacity-70 hover:opacity-100 transition-opacity">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
