    ...
    return (
        <>
            ...
            <nav className="fixed top-[2.0vw] left-1/2 -translate-x-1/2 z-50 h-10 hidden md:flex items-center justify-between px-2 rounded-full bg-white/60 backdrop-blur-md shadow-[0_4px_24px_rgba(0,28,61,0.08)] border border-white/40 w-[53vw]">
                ...
                <Link href="https://shop.ucmsa.nl/" className="text-[#001C3D] px-4 py-1 rounded-full text-[2.1vh] hover:bg-[#001C3D] hover:text-[#FFF8F0] transition-all duration-200">
                    Shop
                </Link>
 
                <div className="h-4 w-px bg-[#001C3D]/15" />
 
                <Link href="/Documents" className="text-[#001C3D] px-4 py-1 rounded-full text-[2.1vh] hover:bg-[#001C3D] hover:text-[#FFF8F0] transition-all duration-200">
                    Documents
                </Link>
 
                <div className="h-4 w-px bg-[#001C3D]/15" />
 
                <Link href="/Faq" className="text-[#001C3D] px-4 py-1 rounded-full text-[2.1vh] hover:bg-[#001C3D] hover:text-[#FFF8F0] transition-all duration-200">
                    FAQ
                </Link>
            </nav>
            ...
            <div className="md:hidden fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[90vw]">
                ...
                <div className={`mt-2 rounded-2xl border border-white/40 bg-white/80 backdrop-blur-xl shadow-[0_8px_40px_rgba(0,28,61,0.12)] overflow-hidden transition-all duration-300 ease-in-out ${mobileOpen ? 'max-h-72 opacity-100' : 'max-h-0 opacity-0'}`}>
                    <div className="flex flex-col py-3">
                        <Link href="/" onClick={() => setMobileOpen(false)} className="px-6 py-3 text-[#001C3D] text-sm hover:bg-[#001C3D]/5 transition-colors">
                            Home
                        </Link>
                        <Link href="/Committees" onClick={() => setMobileOpen(false)} className="px-6 py-3 text-[#001C3D]/70 text-sm hover:bg-[#001C3D]/5 hover:text-[#001C3D] transition-colors">
                            Committees
                        </Link>
                        <Link href="/PreviousBoards" onClick={() => setMobileOpen(false)} className="px-6 py-3 text-[#001C3D]/70 text-sm hover:bg-[#001C3D]/5 hover:text-[#001C3D] transition-colors">
                            Previous Boards
                        </Link>
                        <div className="mx-6 my-1 h-px bg-[#001C3D]/10" />
                        <Link href="https://shop.ucmsa.nl/" onClick={() => setMobileOpen(false)} className="px-6 py-3 text-[#001C3D]/70 text-sm hover:bg-[#001C3D]/5 hover:text-[#001C3D] transition-colors">
                            Shop
                        </Link>
                        <Link href="/Documents" onClick={() => setMobileOpen(false)} className="px-6 py-3 text-[#001C3D]/70 text-sm hover:bg-[#001C3D]/5 hover:text-[#001C3D] transition-colors">
                            Documents
                        </Link>
                        <Link href="/Faq" onClick={() => setMobileOpen(false)} className="px-6 py-3 text-[#001C3D]/70 text-sm hover:bg-[#001C3D]/5 hover:text-[#001C3D] transition-colors">
                            FAQ
                        </Link>
                    </div>
                </div>
